    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            ...
            <div class="content-card fade-up">
                ...
                <div style="padding: var(--spacing-md); color: var(--color-gray-700);">
                    <p>Zone de configuration à relier aux réglages (paiements, notifications, etc.).</p>
                    <p>Ajouter ici vos formulaires de configuration selon les besoins.</p>
                </div>
            </div>
        </main>
    </div>
